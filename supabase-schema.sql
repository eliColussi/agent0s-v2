...
-- Indexes
CREATE INDEX ON library_items (category);
CREATE INDEX ON library_items (tool);
CREATE INDEX ON library_items (difficulty);
CREATE INDEX ON library_items (created_at DESC);
