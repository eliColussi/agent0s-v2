...
export default function LibraryCard({ item, index = 0 }: Props) {
  ...
  return (
    <div
      className="library-card card-enter glass-border-glow"
      style={{
        height: '100%',
        borderRadius: 14,
    ...
    >
      <Link
        ...
        style={{ display: 'flex', flexDirection: 'column', height: '100%', textDecoration: 'none', padding: '18px 20px 16px' }}
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" strokeWidth="2" style={{ opacity: 0.5 }}>
